...
* In production environment: To update a breadcrumb translation used with an attribute, you also have to update the class file where the breadcrumb is used. Then you can clear the cache.
